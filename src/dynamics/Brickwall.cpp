...
void ofx::patch::dynamics::Brickwall::patch(){
...
void ofx::patch::dynamics::Brickwall::drawScope( int x, int y, int w, int h ) {
    ofPushMatrix();
    ofTranslate( x, y );
...
void ofx::patch::dynamics::Brickwall::drawMeter( int x, int y, int w, int h ) {
    ofPushMatrix();
    ofTranslate( x, y );
...
void ofx::patch::dynamics::Brickwall::draw( int x, int y, int w, int h ){
    int hscope = h - 30;
    drawScope( x, y, w, hscope );
    drawMeter( x, y+hscope+10, w, 20 );
}

ofParameterGroup & ofx::patch::dynamics::Brickwall::label( std::string name ){
    parameters.setName(name);
    return parameters;
}

float ofx::patch::dynamics::Brickwall::meter_GR() const {
    return comp.meter_GR();
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::in_0() {
    return in("0");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::in_1() {
    return in("1");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::out_0() {
    return out("0");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::out_1() {
    return out("1");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::in_L() {
    return in("0");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::in_R() {
    return in("1");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::out_L() {
    return out("0");
}

pdsp::Patchable & ofx::patch::dynamics::Brickwall::out_R() {
    return out("1");
}
