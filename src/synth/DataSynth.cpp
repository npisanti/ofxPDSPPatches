...
ofParameterGroup & ofx::patch::synth::DataSynth::setup(int numVoices, float spread, std::string name ){
...
pdsp::Patchable& ofx::patch::synth::DataSynth::Voice::in_trig(){
    return in("trig");
}

pdsp::Patchable& ofx::patch::synth::DataSynth::Voice::in_pitch(){
    return in("pitch");
}

void ofx::patch::synth::DataSynth::Voice::setup( DataSynth & m ){
...
float ofx::patch::synth::DataSynth::Voice::meter_mod_env() const{
    return envelope.meter_output();
}

float ofx::patch::synth::DataSynth::Voice::meter_pitch() const{
    return oscillator.meter_pitch();
}

pdsp::Patchable& ofx::patch::synth::DataSynth::out_L(){
    return gain.out_0();
}

pdsp::Patchable& ofx::patch::synth::DataSynth::out_R(){
    return gain.out_1();
}

ofParameterGroup & ofx::patch::synth::DataSynth::label (std::string name ){
    parameters.setName( name );
    return parameters;
}
