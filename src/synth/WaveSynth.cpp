...
ofParameterGroup & ofx::patch::synth::WaveSynth::setup( int numVoices, float spread, std::string name ){
...
void ofx::patch::synth::WaveSynth::Voice::setup( WaveSynth & m ){
...
float ofx::patch::synth::WaveSynth::Voice::meter_mod_env() const{
    return envelope.meter_output();
}

float ofx::patch::synth::WaveSynth::Voice::meter_pitch() const{
    return oscillator.meter_pitch();
}

pdsp::Patchable& ofx::patch::synth::WaveSynth::out_L(){
    return gain.out_0();
}

pdsp::Patchable& ofx::patch::synth::WaveSynth::out_R(){
    return gain.out_1();
}

pdsp::Patchable& ofx::patch::synth::WaveSynth::Voice::in_trig(){
    return in("trig");
}

pdsp::Patchable& ofx::patch::synth::WaveSynth::Voice::in_pitch(){
    return in("pitch");
}
pdsp::Patchable& ofx::patch::synth::WaveSynth::Voice::in_table(){
    return in("table");
}

pdsp::Patchable& ofx::patch::synth::WaveSynth::Voice::in_cutoff(){
    return in("cutoff");
}

ofParameterGroup & ofx::patch::synth::WaveSynth::label (std::string name ){
    parameters.setName( name );
    return parameters;
}
