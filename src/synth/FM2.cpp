...
ofParameterGroup & ofx::patch::synth::FM2::setup( int numVoices, float spread, std::string name ){
...
void ofx::patch::synth::FM2::Voice::setup( FM2 & m, int i ){
...
float ofx::patch::synth::FM2::Voice::meter_mod_env() const{
    return envelope.meter_output();
}

float ofx::patch::synth::FM2::Voice::meter_pitch() const{
    return carrier.meter_pitch();
}

pdsp::Patchable& ofx::patch::synth::FM2::out_L(){
    return gain.out_0();
}

pdsp::Patchable& ofx::patch::synth::FM2::out_R(){
    return gain.out_1();
}

pdsp::Patchable& ofx::patch::synth::FM2::Voice::in_trig(){
    return in("trig");
}

pdsp::Patchable& ofx::patch::synth::FM2::Voice::in_pitch(){
    return in("pitch");
}
pdsp::Patchable& ofx::patch::synth::FM2::Voice::in_fm(){
    return in("fm");
}

pdsp::Patchable& ofx::patch::synth::FM2::Voice::in_self(){
    return in("self");
}

ofParameterGroup & ofx::patch::synth::FM2::label (std::string name ){
    parameters.setName( name );
    return parameters;
}
