...
void ofx::patch::synth::SinePercussion::patch(){
...
ofParameterGroup & ofx::patch::synth::SinePercussion::label( string name ){
    parameters.setName( name );
    return parameters;
}

void ofx::patch::synth::SinePercussion::longerEnvelopes() {
...
void ofx::patch::synth::SinePercussion::disableDB( ){
    aEnv.disableDBTriggering( );
}

float ofx::patch::synth::SinePercussion::meter() const {
