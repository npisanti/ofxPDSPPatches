...
void ofx::patch::synth::GrainDrone::resize(int w, int h) {
...
void ofx::patch::synth::GrainDrone::addSample( util::SampleControl & sample ) {
...
ofParameterGroup & ofx::patch::synth::GrainDrone::label( std::string name ){
    parameters.setName( name );
    return parameters;
}

void ofx::patch::synth::GrainDrone::draw( int x, int y ){
...
pdsp::Patchable& ofx::patch::synth::GrainDrone::in_dry_control(){
    return drynode;
}

pdsp::Patchable& ofx::patch::synth::GrainDrone::in_resonator_control( int i ){
    if(i>=0 && i<4){
        return sendnode[i];
    }else{
...
pdsp::Patchable& ofx::patch::synth::GrainDrone::out_L() {
    return voiceAmpL;
}

pdsp::Patchable& ofx::patch::synth::GrainDrone::out_R() {
    return voiceAmpR;
}

pdsp::Patchable& ofx::patch::synth::GrainDrone::in_fb(){
    return fbInput;
}
pdsp::Patchable& ofx::patch::synth::GrainDrone::in_position(){
    return cloud.in_position();
}
    
void ofx::patch::synth::GrainDrone::smoothing( float ms ) {
