...
void ofx::patch::synth::NoiseDevice::patch() {
    ...
    addModuleOutput( "0", gain0 );
    addModuleOutput( "1", gain1 );
...
ofParameterGroup & ofx::patch::synth::NoiseDevice::label( string name ){
    parameters.setName(name);
    return parameters;
}    
    
float ofx::patch::synth::NoiseDevice::meter() const {
    return ampEnv.meter_output();
}

pdsp::Patchable & ofx::patch::synth::NoiseDevice::in_trig(){
    return in("trig");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::in_pitch(){
    return in("pitch");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::in_cutoff(){
    return in("cutoff");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::in_decimate(){
    return in("decimate");
}

pdsp::Patchable & ofx::patch::synth::NoiseDevice::out_0() {
    return out("0");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::out_1() {
    return out("1");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::out_L() {
    return out("0");
}
pdsp::Patchable & ofx::patch::synth::NoiseDevice::out_R() {
    return out("1");
}
